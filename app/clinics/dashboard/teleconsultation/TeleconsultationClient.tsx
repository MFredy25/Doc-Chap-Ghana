    ...
    return onSnapshot(
      ...
      (snapshot) => {
        const rows = snapshot.docs
          .map((item) => ({
            id: item.id,
            ...(item.data() as Omit<TeleconsultationItem, "id">),
          }))
          .filter((item) => {
              ...
              <div className="mt-6 flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="mt-3 max-w-3xl text-sm leading-7 text-blue-100 sm:text-base">
                    Access and follow your clinic video consultations.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="flex items-center justify-between gap-4">
                <div>
                  ...
                  <p className="mt-1 text-sm text-zinc-500">
                    Video consultations associated with your clinic.
                  </p>
                </div>
                    ...
                    >
                      ...
                      {session.meetingLink && (
                        <a
                          ...
                          target="_blank"
                          rel="noreferrer"
                          className="mt-4 inline-flex w-full items-center justify-center rounded-xl bg-violet-600 px-4 py-3 text-sm font-bold text-white transition hover:bg-violet-500"
                        >
