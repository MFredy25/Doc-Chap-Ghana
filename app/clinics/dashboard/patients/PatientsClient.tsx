      ...
      (snapshot) => {
        setPatients(
          snapshot.docs.map((item) => ({
            id: item.id,
            ...(item.data() as Omit<PatientItem, "id">),
          }))
        );
      }
    );
              ...
              <div className="mt-6 flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="mt-3 max-w-3xl text-sm leading-7 text-blue-100 sm:text-base">
                    Access and follow patients associated with your clinic.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="flex items-center justify-between gap-4">
                <div>
                  ...
                  <p className="mt-1 text-sm text-zinc-500">
                    {patients.length} patient{patients.length === 1 ? "" : "s"} linked to your clinic.
                  </p>
                </div>
