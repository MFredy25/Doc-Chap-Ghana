      ...
      (snapshot) => {
        setMessages(
          snapshot.docs.map((item) => ({
            id: item.id,
            ...(item.data() as Omit<MessageItem, "id">),
          }))
        );
      }
    );
              ...
              <div className="mt-6 flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="mt-3 max-w-3xl text-sm leading-7 text-blue-100 sm:text-base">
                    Access messages and conversations associated with your clinic.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="flex items-center justify-between gap-4">
                <div>
                  ...
                  <p className="mt-1 text-sm text-zinc-500">
                    Conversations and messages linked to your clinic.
                  </p>
                </div>
                    ...
                    >
                      <div className="flex items-center justify-between gap-3">
                        <div className="text-sm font-black text-zinc-950 dark:text-white">
                          {message.senderName || message.recipientName || "Conversation"}
                        </div>
