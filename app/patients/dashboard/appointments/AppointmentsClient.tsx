              ...
              {[
                ...
                (
                  ...
                  <button
                    ...
                    className={`rounded-[22px] border bg-gradient-to-br from-[#063b34] via-[#08745e] to-[#10a37f] p-4 text-left text-white transition ${
                      filter ===
                      item.key
                        ? "border-emerald-300 shadow-lg shadow-emerald-900/20 ring-2 ring-emerald-200/70"
                        : "border-emerald-950/20 shadow-sm hover:-translate-y-0.5 hover:border-emerald-300 hover:shadow-md"
                    }`}
                  >
