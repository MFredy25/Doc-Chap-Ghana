...
if (typeof window !== "undefined") {
  ...
  console.log("[Firebase][Client] initialization check", {
  ...
  if (configIsValid) {
    try {
      ...
      /*
       * Keep the same Functions region as your current
       * Doc Chap infrastructure.
       *
       * Change this only if your Ghana Functions project
       * uses another region.
       */
 ...
 *
 * Throws if Firebase has not been initialized in the browser.
 */
...
/* ============================================================
   HISTORICAL / SIMPLE EXPORTS
============================================================ */

/*
 * These exports allow you to continue doing:
 *
 * import { auth, db } from "@/lib/firebase/client";
 *
 * They may be null during SSR/build.
 */
