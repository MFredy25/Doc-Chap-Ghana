  ...
  async function createAccount() {
    ...
    try {
      ...
      try {
        ...
        console.warn(
          "[PatientSignup] Verification email error:",
          verificationError
        );
      }
      ...
      try {
        ...
        console.warn(
          "[PatientSignup] Token refresh error:",
          tokenError
        );
      }
      ...
      try {
        const response =
          await fetch(
            "/api/send-email-new-patient-add",
            {
              method:
                "POST",
        ...
        if (
          ...
          console.warn(
            "[PatientSignup] Registration notification email failed:",
            payload
          );
        }
      } catch (
        ...
        /*
         * The patient account has already been created.
         * An email problem must not invalidate registration.
         */
        console.warn(
          "[PatientSignup] Registration notification error:",
          notificationError
        );
      }

      console.log(
        "[PatientSignup] Patient account created:",
        {
          uid,
          email:
            cleanEmail,
      ...
      router.replace("/patients/dashboard/my-account");
