    ...
    try {
      ...
      setSuccessMessage(
        plan.price ===
          ...
          : `${plan.name} plan selected. Payment activation can be connected when your subscription payment flow is ready.`
      );
      ...
      console.error(
        "[DoctorSubscriptions] Select plan error:",
        selectionError
      );
    ...
    <div className="min-h-screen bg-[#f6f8fc] dark:bg-black">
                ...
                (
                  ...
                  return (
                    <article
                      ...
                      className={`relative flex h-full flex-col overflow-hidden rounded-[30px] border bg-white p-5 shadow-sm transition sm:p-6 dark:bg-zinc-950 ${
                        plan.featured
      ...
      {confirmPlan && (
        ...
        >
          ...
          <div className="relative z-10 w-full max-w-md rounded-[28px] border border-zinc-200 bg-white p-6 shadow-2xl dark:border-zinc-800 dark:bg-zinc-950">
            <button
              type="button"
              onClick={() =>
                setConfirmPlan(
              ...
              className="absolute right-4 top-4 flex h-9 w-9 items-center justify-center rounded-xl bg-zinc-100 text-zinc-500 transition hover:bg-zinc-200 dark:bg-zinc-900 dark:text-zinc-300"
              aria-label="Close"
            >
              <X className="h-4 w-4" />
            </button>
            ...
            <div
              className={`flex h-12 w-12 items-center justify-center rounded-2xl ${confirmPlan.iconClass}`}
            >
              {React.createElement(
                confirmPlan.icon,
                {
            ...
            <p className="mt-2 text-sm leading-6 text-zinc-500 dark:text-zinc-400">
              {confirmPlan.price ===
              0
                ? "This will activate the Essential plan on your doctor account."
                : `This will select the ${confirmPlan.name} plan at ${formatPrice(
                    confirmPlan.price,
                    confirmPlan.currency
                  )} per month. No payment will be charged from this page yet.`}
            </p>
            ...
            <div className="mt-6 flex flex-col-reverse gap-3 sm:flex-row sm:justify-end">
              <button
                ...
                className="rounded-2xl border border-zinc-200 px-4 py-3 text-sm font-bold text-zinc-700 transition hover:bg-zinc-50 dark:border-zinc-700 dark:text-zinc-300 dark:hover:bg-zinc-900"
              >
                Cancel
              </button>
