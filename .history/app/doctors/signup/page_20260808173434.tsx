            ...
            <div className="grid grid-cols-1 items-center gap-10 lg:grid-cols-2">
              ...
              <div style={heroStyle}>
                ...
                <p className="mt-4 leading-relaxed text-zinc-700 dark:text-zinc-300">
                  Join Doc Chap Ghana to grow your practice through appointment
                  management, teleconsultation, patient follow-up and payments
                ...
                <div className="mt-6 flex flex-col gap-3 sm:flex-row">
                  <button
                    ...
                    style={{
                      animation: "softPulse 2.2s ease-in-out .9s infinite",
                    }}
                  >
                    Start registration
                ...
                <div className="relative mt-4 overflow-hidden rounded-2xl border border-amber-200 bg-amber-50 p-4 text-sm text-amber-900 shadow-sm">
                  ...
                  <div className="relative">
                    ...
                    <p className="mt-3 leading-relaxed">
                      Your password must have at least <b>8 characters</b>,
                      including <b>1 uppercase letter</b>,{" "}
                      <b>1 lowercase letter</b>, <b>1 number</b> and{" "}
                  ...
                  <div className="relative">
                    ...
                    <div className="mt-5 flex flex-col items-center text-center">
                      ...
                      <p className="mt-3 text-xs text-zinc-600 dark:text-zinc-400">
                        Create your professional account to manage appointments
                    ...
                    {submitted ? (
                      <div className="mt-6 rounded-2xl border border-emerald-200 bg-emerald-50 p-4 text-sm text-emerald-900">
                        ...
                        <p className="mt-1">
                          Your Doc Chap Ghana registration will be activated
                          once the Ghana Firebase environment is connected.
                        </p>

                        <Link
                          href="/doctors/login"
                          className="mt-4 flex w-full items-center justify-center gap-2 rounded-xl bg-blue-600 px-5 py-3 text-sm font-semibold text-white shadow-md transition hover:bg-blue-500"
                        >
                          Log in
                      ...
                      <form onSubmit={submit} className="mt-6 space-y-4">
                        <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
                          {[
                            ["Last name", "lastName", "e.g. Mensah"],
                            ["First name", "firstName", "e.g. Ama"],
                          ].map(([l, n, p]) => (
                            <label
                              key={n}
                              className="space-y-2 text-sm font-medium text-zinc-800 dark:text-zinc-200"
                            >
                              {l}

                              <div className="flex items-center gap-2 rounded-xl border border-zinc-200 bg-white/80 px-3 py-2 dark:border-zinc-800 dark:bg-zinc-950/60">
                        ...
                        <button
                          type="submit"
                          className="flex w-full items-center justify-center gap-2 rounded-xl bg-blue-600 px-5 py-3 text-sm font-semibold text-white shadow-md transition hover:bg-blue-500"
                        >
                        ...
                        <p className="text-center text-xs text-zinc-500 dark:text-zinc-400">
                          Already registered? Access your Doc Chap Ghana doctor
                          space.
                        </p>
                      </form>
                    )}
