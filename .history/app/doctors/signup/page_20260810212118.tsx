  ...
  async function submit(
    ...
    try {
      ...
      try {
        ...
        console.warn(
          "[DoctorSignup] Verification email error:",
          verificationError
        );
      }
      ...
      try {
        ...
        console.warn(
          "[DoctorSignup] Token refresh error:",
          tokenError
        );
      }
      ...
      try {
        ...
        if (
          ...
          console.warn(
            "[DoctorSignup] Registration notification email failed:",
            payload
          );
        }
      } catch (
        ...
        /*
         * The doctor account has already been created successfully.
         * An email delivery problem must not roll back the account.
         */
        console.warn(
          "[DoctorSignup] Registration notification error:",
          notificationError
        );
      }
