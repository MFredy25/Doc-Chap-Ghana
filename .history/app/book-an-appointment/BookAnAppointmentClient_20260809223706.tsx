        ...
        async function loadProvider() {
            ...
            try {
                ...
                if (
                    ...
                    console.error(
                        "[BookAppointment] Non-JSON API response:",
                        {
                            status:
                                response.status,
                            statusText:
                    ...
                    if (
                        ...
                        throw new Error(
                            "The appointment availability API route was not found. Check that app/api/book-an-appointment/availability/route.ts exists."
                        );
                    }

                    throw new Error(
                        `The appointment availability service returned an invalid response (${response.status}).`
                    );
                }
                ...
                if (
                    ...
                    throw new Error(
                        payload.error ||
                        `Unable to load this provider (${response.status}).`
                    );
                }
...
// app/book-an-appointment/BookAnAppointmentClient.tsx