      ...
      <div className="px-4 pt-5">
        <div className="rounded-[22px] border border-emerald-100 bg-white p-4 shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
          <div className="flex items-center gap-3">
            <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl bg-emerald-50 text-emerald-700 dark:bg-emerald-950/30 dark:text-emerald-300">
                ...
                <Link
                  ...
                  className={`group flex items-center gap-3 rounded-2xl px-3.5 py-3 text-sm font-bold transition ${
                    active
                      ...
                      : "text-zinc-700 hover:bg-white hover:text-emerald-700 dark:text-zinc-300 dark:hover:bg-zinc-900 dark:hover:text-emerald-300"
                  }`}
                >
                  <Icon
