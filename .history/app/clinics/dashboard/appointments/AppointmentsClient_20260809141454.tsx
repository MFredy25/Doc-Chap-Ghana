      ...
      (snapshot) => {
        setAppointments(
          snapshot.docs.map((item) => ({
            id: item.id,
            ...(item.data() as Omit<AppointmentItem, "id">),
          }))
        );
      }
    );
              ...
              <div className="mt-6 flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="mt-3 max-w-3xl text-sm leading-7 text-blue-100 sm:text-base">
                    Review and manage appointments linked to your clinic.
                  </p>
                </div>
              </div>
            </div>
              ...
              {appointments.length === 0 ? (
                ...
                <div className="mt-6 space-y-3">
                  {appointments.map((appointment) => (
                    <article
                      key={appointment.id}
                      className="flex flex-col gap-3 rounded-2xl border border-zinc-200 bg-zinc-50 p-4 sm:flex-row sm:items-center sm:justify-between dark:border-zinc-800 dark:bg-zinc-900/60"
                    >
                      <div>
                      ...
                      <span className="inline-flex w-fit rounded-full bg-blue-50 px-3 py-1 text-xs font-bold text-blue-700 dark:bg-blue-950/40 dark:text-blue-300">
