                        ...
                        (
                          ...
                          return (
                            <Link
                              ...
                              href={`/clinics/dashboard/appointments/${encodeURIComponent(
                                appointment.id
                              )}`}
                              className="block rounded-[22px] border border-zinc-200 bg-zinc-50 p-4 transition hover:-translate-y-0.5 hover:border-blue-300 hover:bg-white hover:shadow-md dark:border-zinc-800 dark:bg-zinc-900/60 dark:hover:bg-zinc-900"
                            >
