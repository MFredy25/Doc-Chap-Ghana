    ...
    <div className="min-h-screen bg-[#f6f8fc] dark:bg-black">
      ...
      <div className="lg:pl-72">
        ...
        <main>
          ...
          <section className="px-4 py-5 sm:px-6 sm:py-6 lg:px-10 lg:py-7">
            {error && (
            ...
            {/* CURRENT PLAN + BILLING CHIPS */}

            <div className="mb-5 rounded-[24px] border border-zinc-200 bg-white p-4 shadow-sm sm:p-5 dark:border-zinc-800 dark:bg-zinc-950">
                ...
                <div className="flex min-w-0 items-start gap-3">
                  ...
                  <div className="min-w-0">
                    <div className="flex flex-wrap items-center gap-2">
                      ...
                      {currentPlan && (
                        <span className="inline-flex items-center gap-1.5 rounded-full border border-emerald-200 bg-emerald-50 px-2.5 py-1 text-[10px] font-bold text-emerald-700 dark:border-emerald-900/40 dark:bg-emerald-950/20 dark:text-emerald-300">
                    ...
                    <p className="mt-1 text-[11px] leading-5 text-zinc-500 dark:text-zinc-400">
                      Select a billing period, then choose the plan that fits your clinic.
                    </p>
                  </div>
                </div>
                        ...
                        <button
                          ...
                          className={`inline-flex items-center gap-1.5 rounded-xl border px-3 py-2 text-[11px] font-black transition ${
                            selected
                              ...
                              : option.months ===
                                12
                              ? "border-amber-200 bg-amber-50 text-amber-800 hover:border-amber-300 dark:border-amber-900/50 dark:bg-amber-950/30 dark:text-amber-300"
                              : "border-zinc-200 bg-zinc-50 text-zinc-700 hover:border-blue-300 hover:bg-blue-50 dark:border-zinc-800 dark:bg-zinc-900 dark:text-zinc-300"
                          }`}
                        >
                          <span>
                            {option.months ===
                ...
                (
                  ...
                  return (
                    ...
                    >
                      ...
                      <h2 className="mt-4 text-xl font-black text-zinc-950 dark:text-white">
                        {plan.name}
                      </h2>
                      ...
                      <div className="mt-5 border-y border-zinc-100 py-4 dark:border-zinc-800">
            ...
            <div className="mt-5 rounded-[22px] border border-blue-200 bg-blue-50/70 p-4 dark:border-blue-900/40 dark:bg-blue-950/20">
