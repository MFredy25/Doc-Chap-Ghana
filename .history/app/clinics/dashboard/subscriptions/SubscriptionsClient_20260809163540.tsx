                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="mt-6 border-y border-zinc-100 py-5 dark:border-zinc-800">
                        ...
                        <div className="mt-3 inline-flex items-center gap-2 rounded-xl bg-zinc-100 px-3 py-2 text-xs font-bold text-zinc-700 dark:bg-zinc-900 dark:text-zinc-200">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="mt-1 text-xs leading-5 text-zinc-600 dark:text-zinc-400">
                    Plan selection is recorded only on your clinic account. Free can be activated immediately. Paid plans can be connected to your subscription payment flow for automatic activation.
                  </p>
                </div>
              </div>
            </div>
