...
export default function ClinicSignupPage() {
  ...
  async function submit(
    ...
    try {
      ...
      /* --------------------------------------------------------
         REGISTRATION EMAILS — CLINIC + ADMIN
      -------------------------------------------------------- */
      ...
      try {
        ...
        if (
          ...
          console.warn(
            "[ClinicSignup] Registration notification email failed:",
            emailPayload
          );
        }
      } catch (notificationError) {
        console.warn(
          "[ClinicSignup] Registration notification error:",
          notificationError
        );
      }
