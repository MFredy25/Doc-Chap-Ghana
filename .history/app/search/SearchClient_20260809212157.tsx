...
function mapDoctor(
  ...
  return {
    ...
    active:
      ...
      false,
    href:
      `/search/${encodeURIComponent(id)}?type=doctor`,
  };
}
...
function mapClinic(
  ...
  return {
    ...
    active:
      ...
      false,
    href:
      `/search/${encodeURIComponent(id)}?type=clinic`,
  };
}
...
function mapPharmacy(
  ...
  return {
    ...
    active:
      ...
      false,
    href:
      `/search/${encodeURIComponent(id)}?type=pharmacy`,
  };
}
  ...
  useEffect(() => {
    ...
    async function loadDirectory() {
      ...
      try {
        ...
        console.error(
          "[HealthSearch] Directory load error:",
          loadError
        );
        ...
        setErrors([
          "Unable to load the healthcare directory. Please try again.",
        ]);
      } finally {
        if (
          !cancelled
  ...
  return (
    <div className="min-h-screen bg-[#f7faf9] dark:bg-black">
      ...
      <main>
          ...
          >
            <div className="absolute inset-0 bg-gradient-to-r from-black/75 via-black/55 to-emerald-950/45" />
            <div className="pointer-events-none absolute -right-24 -top-24 h-96 w-96 rounded-full bg-cyan-300/20 blur-3xl" />

            <div className="relative px-4 py-12 sm:px-6 sm:py-16 lg:px-10">
              <div className="max-w-4xl">
                ...
                <p className="mt-3 max-w-3xl text-sm leading-7 text-emerald-50 sm:text-base">
                  Search doctors, clinics and pharmacies that are available and visible on Doc Chap Ghana.
                </p>
