...
export default function BookAnAppointmentClient() {
  ...
  const [
    ...
    useState<ApiResponse["appointment"] | null>(
      null
    );
          ...
          <div className="overflow-hidden rounded-[32px] border border-emerald-200 bg-white shadow-sm dark:border-emerald-900/40 dark:bg-zinc-950">
            <div className="bg-emerald-600 px-6 py-10 text-center text-white">
              ...
              <p className="mt-2 text-sm">
                Your appointment with {confirmed.providerName} has been confirmed.
              </p>
            </div>
            ...
            <div className="p-6">
              ...
              <Link
                ...
                className="mt-5 flex w-full items-center justify-center rounded-2xl bg-emerald-600 px-5 py-3.5 text-sm font-black text-white"
              >
                Back to clinic
              </Link>
            </div>
